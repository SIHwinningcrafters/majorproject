...
export function useIncidents(filters = {}) {
  const { refreshKey } = useApp();          // 👈 watch for refresh
  ...
  }, [JSON.stringify(filters), refreshKey]); // 👈 refreshKey in deps

  useEffect(() => { fetchIncidents(); }, [fetchIncidents]);

  return { incidents, loading, error, totalPages, refetch: fetchIncidents };
}
