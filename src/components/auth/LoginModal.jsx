    ...
    <Overlay onClose={closeAuthModal}>
      <div style={styles.modal}>
        ...
        <div style={styles.brand}>
          <span style={styles.brandDot} />SafeMap
        </div>
...
/* shared exports used by SignupModal and ReportModal */
  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: 6 }}>
      <label style={styles.label}>
        {label}
        {hint && <span style={{ fontWeight: 400, color: "var(--muted)", fontSize: 12 }}> — {hint}</span>}
      </label>
      {children}
    </div>
  );
...
const styles = {
  modal: {
    ...
    borderRadius: "var(--r-xl)", padding: "32px 32px 24px",
  ...
  title: {
    ...
    fontWeight: 800, marginBottom: 6, letterSpacing: "-0.3px",
  },
  sub: { fontSize: 13, color: "var(--muted)", marginBottom: 24, lineHeight: 1.5 },
  form: { display: "flex", flexDirection: "column", gap: 16 },
  label: { fontSize: 13, fontWeight: 500, color: "var(--muted2)" },
  input: {
  ...
  error: {
    background: "rgba(232,64,42,0.12)", border: "1px solid rgba(232,64,42,0.25)",
  ...
  footer: {
    ...
    gap: 8, marginTop: 20, paddingTop: 16,
