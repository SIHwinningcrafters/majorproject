...
export default function Navbar() {
  const { activePage, setActivePage, openAuthModal, openReportModal, openProfile } = useApp();
  ...
  return (
    <nav style={styles.nav}>
      ...
      <div style={styles.actions}>
        {user ? (
          <>
            <button style={styles.btnReport} onClick={openReportModal}>
              + Report
            </button>
...
const styles = {
  ...
  logo: {
    ...
    fontSize: 19, letterSpacing: "-0.4px",
    display: "flex", alignItems: "center", gap: 9,
    cursor: "pointer", userSelect: "none",
  },
  logoDot: {
    width: 9, height: 9, background: "var(--red)",
  ...
  navLinkActive: { color: "var(--text)", background: "var(--dark3)" },
